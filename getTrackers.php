        ...
        */
        ...
        if ($result->num_rows>0){
            ...
            while ($row = $result -> fetch_assoc()){
                ...
                $latLF = $devices[30]["lat"];
                $longLF = $devices[30]["lon"];
                
                $latLMW = $devices[32]["lat"];
                $longLMW = $devices[32]["lon"];
                
                $latLFW = $devices[33]["lat"];
                $longLFW = $devices[33]["lon"];
                
                $latFW = $devices[34]["lat"];
                $longFW = $devices[34]["lon"];
                
                $latT = $devices[31]["lat"];
                $longT = $devices[31]["lon"];
