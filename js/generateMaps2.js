...
function getMinute() {
	...
	startedTime.setHours(1);
	startedTime.setMinutes(0);
	...
	var elapsedMinutes = parseInt((elapsedTime % (3600*1000))/60000);
    
     ("Minute: "+elapsedMinutes);
    return (elapsedMinutes*4)+30;
